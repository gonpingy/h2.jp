...
?>
    ...
    <div id="hhwrapper">
      ...
      <div id="section_one">
        ...
        <h2 class="stxt stxt01 pc cbefore">ハンディ流家づくり<br>「妄想から打ち上げまで」を<br>もっと広げたい、増やしたい。</h2>
        <div class="simg simg01 sp"></div>
        ...
        <div class="stxt stxt02 pc cbefore">
          <ul>
            <li>_みんなの「妄想力を培う」ため、ハンディとみんなでワイワイ妄想スクールをはじめたい。 </li>
            <li>_打ち上げが終わった後も、みんなが「家づくりを楽しみ続けるための場所」を提供したい。 </li>
            <li>_ハンディハウスができる「仲間」を増やしたい。</li>
            <li>_住まいを提供する企業の皆さんに、「ハンディマインド」を伝えたい。</li>
          </ul>
        </div>
        <div class="simg simg02 sp"></div>
        <div class="stxt stxt02 sp">
          <ul>
            <li>_みんなの「妄想力を培う」ため、ハンディとみんなでワイワイ妄想スクールをはじめたい。 </li>
            <li>_打ち上げが終わった後も、みんなが「家づくりを楽しみ続けるための場所」を提供したい。 </li>
            <li>_ハンディハウスができる「仲間」を増やしたい。</li>
        ...
        <div class="stxt stxt03 pc cbefore">
           <p class="">HandiHouse projectが始まって7年が経ち、僕たちの中にこんな思いが<br>芽生えてきました。</p>
           <p class="">ひとつの場所も持って、もっと仲間を受け入れやすくして<br>もうすぐ HandiHouse project 第2章をはじめます。</p>
         </div>
         <div class="simg simg03 sp"></div>
         <div class="stxt stxt03 sp">
            <p class="">HandiHouse projectが始まって7年が経ち、僕たちの中にこんな思いが芽生えてきました。</p>
            <p class="">ひとつの場所も持って、もっと仲間を受け入れやすくしてもうすぐ HandiHouse project 第2章をはじめます。</p>
          </div>
      </div>

      <div id="section_two" class="cbefore">
        <div class="newproject cbefore2">
          <div class="np_label">NEW PROJECT</div>
          <div><h2>Handi<br>KOMAOKA LABO<br>2018 OPEN!!</h2></div>
          <article>HandiHouse projectの家づくり「妄想から打ち上げまで」をもっと楽しくするための研究と実験の場であり、Handi第2章の出発点となる大きなラボラトリーをオープンさせます。
考え、つくり、笑い、苦労し、楽しむ。これまで僕らが家づくりの現場でおこなってきたLIVEがKOMAOKA LABOに行けばある！！そんな場所をつくります。
          </article>
        </div>
      </div>

      <div id="section_two_sp" class="">
