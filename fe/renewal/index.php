  ...
  <div id="hhwrapper" class="top">
    ...
    <div id="secondview">
      <div id="header_w" class="pc">
        <h1><a href="index.html"><img src="<?= DIR_IMG ?>/hh_logo_w.png" alt="HandiHouse"></a></h1>
        <ul id="g_nav" class="pc">
          ...
          <li><a href="company.html">COMPANY</a></li>
          <li><a href="contact.html"><img src="<?= DIR_IMG ?>/i_contact_w.png" alt="CONTACT"></a></li>
          <li><a href="https://www.facebook.com/HandiHouseproject/" target="_blank"><img src="<?= DIR_IMG ?>/i_fb_w.png" alt="HandiHouse facebook"></a></li>
          <li><a href="https://www.instagram.com/handihouseproject/" target="_blank"><img src="<?= DIR_IMG ?>/i_insta_w.png" alt="HandiHouse instagram"></a></li>
        </ul>
      </div>
    ...
    <div id="section_one">
      ...
      <a href="vision.html" class="btn_a">VISION</a>
    </div>
    ...
    <div id="section_two">
      ...
      <a href="company.html#a_member" class="btn_a">VIEW MORE</a>
    </div>
